<template>
    <div class="flex flex-nowrap">
        <div class="sidebar absolute w-72 max-md:hidden card md:relative shadow flex-col justify-between hidden md:flex min-h-screen !mb-0">
        ...
        <div class="container mx-auto p-2 h-64 md:w-4/5 md:px-6">
                                    ...
                                    <li>
                                        ...
                                        <ul class="list-none p-0 m-0 overflow-hidden">
                                            <li>
                                                ...
                                                <ul
                                                    class="list-none py-0 pl-3 pr-0 m-0 hidden overflow-y-hidden transition-all duration-400 ease-in-out">
                                                    <li>
                                                        <a v-ripple v-styleclass="{
                                                            selector: '@next',
                                                            enterClass: 'hidden',
